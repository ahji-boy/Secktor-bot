...
\n*Visit For Tutorial :-*
 _https://www.Youtube.com/@xIKRATOSx_
\n\n${Config.caption}`
...
cmd({
        pattern: "link",
        alias: ["ytube", "yt", "myyt"],
        desc: "Sends info about My Ytube Channel __CheckOut :_ www.Youtube.com/@xIKRATOSx",
        category: "general",
        filename: __filename,
    },
    async(Void, citel) => {
...
*🍁 Channel Link:* _https://youtube.com/@xIKRATOSx_\n
╭━━━━━━━━━━━━━━━━━━━━╮
┇  ╔═╦╗╔╦╗╔═╦═╦╦╦╦╗╔═╗
┇  ║╚╣║║║╚╣╚╣╔╣╔╣║╚╣═╣
┇  ╠╗║╚╝║║╠╗║╚╣║║║║║═╣
...
*🌟Description:* A WhatsApp bot with rich features, Created By *Ahmad Ali*.\n
*⚡Speed:* ${latensie.toFixed(4)} ms
*🚦Uptime:* ${runtime(process.uptime())}
*🕸Version:* 1.0.0
*👤Owner:*  ${Config.ownername}\n\n
*Powered by 'Ahmad Ali'*
*Youtube :* _youtube.com/@xIKRATOSx_
\n\n${Config.caption}`;
        let buttonMessaged = {
            image: { url: await botpic() },
            caption: ter,
